...
int* rand_batch(int range, int len){
    srand((int)time(0));
    
    int* batch = malloc(sizeof(char)*len);
    int i=0;
    int cnt = 0;
    int exist = 0;
    for(i=0; i<exist; i++){
...
void run_detector(int argc, char **argv)
{
    ...
    //else if(0==strcmp(argv[2], "train")) train_with_validate(datacfg, cfg, weights, gpus, ngpus, clear);
